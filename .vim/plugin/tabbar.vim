...
if ! hasmapto('1') || !hasmapto('<M-1>')
      ...
      if has('mac')
          ...
          noremap <C-S-TAB>   :call <SID>Bf_Cycle(1)<CR>:<BS>
          noremap <D-1> :call <SID>Bf_SwitchTo(1)<CR>:<BS>
          noremap <D-2> :call <SID>Bf_SwitchTo(2)<CR>:<BS>
          noremap <D-3> :call <SID>Bf_SwitchTo(3)<CR>:<BS>
          noremap <D-4> :call <SID>Bf_SwitchTo(4)<CR>:<BS>
          noremap <D-5> :call <SID>Bf_SwitchTo(5)<CR>:<BS>
          noremap <D-6> :call <SID>Bf_SwitchTo(6)<CR>:<BS>
          noremap <D-7> :call <SID>Bf_SwitchTo(7)<CR>:<BS>
          noremap <D-8> :call <SID>Bf_SwitchTo(8)<CR>:<BS>
          noremap <D-9> :call <SID>Bf_SwitchTo(9)<CR>:<BS>
          noremap <D-0> :call <SID>Bf_SwitchTo(10)<CR>:<BS>
          inoremap <D-1> <esc>:call <SID>Bf_SwitchTo(1)<CR>:<BS>a
          inoremap <D-2> <esc>:call <SID>Bf_SwitchTo(2)<CR>:<BS>a
          inoremap <D-3> <esc>:call <SID>Bf_SwitchTo(3)<CR>:<BS>a
          inoremap <D-4> <esc>:call <SID>Bf_SwitchTo(4)<CR>:<BS>a
          inoremap <D-5> <esc>:call <SID>Bf_SwitchTo(5)<CR>:<BS>a
          inoremap <D-6> <esc>:call <SID>Bf_SwitchTo(6)<CR>:<BS>a
          inoremap <D-7> <esc>:call <SID>Bf_SwitchTo(7)<CR>:<BS>a
          inoremap <D-8> <esc>:call <SID>Bf_SwitchTo(8)<CR>:<BS>a
          inoremap <D-9> <esc>:call <SID>Bf_SwitchTo(9)<CR>:<BS>a
          inoremap <D-0> <esc>:call <SID>Bf_SwitchTo(10)<CR>:<BS>a
      ...
      noremap <unique> <script> <space>1 <esc>:call <SID>Bf_SwitchTo(1)<CR>:<BS>
      noremap <unique> <script> <space>2 <esc>:call <SID>Bf_SwitchTo(2)<CR>:<BS>
      noremap <unique> <script> <space>3 <esc>:call <SID>Bf_SwitchTo(3)<CR>:<BS>
      noremap <unique> <script> <space>4 <esc>:call <SID>Bf_SwitchTo(4)<CR>:<BS>
      noremap <unique> <script> <space>5 <esc>:call <SID>Bf_SwitchTo(5)<CR>:<BS>
      noremap <unique> <script> <space>6 <esc>:call <SID>Bf_SwitchTo(6)<CR>:<BS>
      noremap <unique> <script> <space>7 <esc>:call <SID>Bf_SwitchTo(7)<CR>:<BS>
      noremap <unique> <script> <space>8 <esc>:call <SID>Bf_SwitchTo(8)<CR>:<BS>
      noremap <unique> <script> <space>9 <esc>:call <SID>Bf_SwitchTo(9)<CR>:<BS>
      noremap <unique> <script> <space>0 <esc>:call <SID>Bf_SwitchTo(10)<CR>:<BS>
      noremap <unique> <script> <space><space>1 <esc>:call <SID>Bf_SwitchTo(11)<CR>:<BS>
      noremap <unique> <script> <space><space>2 <esc>:call <SID>Bf_SwitchTo(12)<CR>:<BS>
      noremap <unique> <script> <space><space>3 <esc>:call <SID>Bf_SwitchTo(13)<CR>:<BS>
      noremap <unique> <script> <space><space>4 <esc>:call <SID>Bf_SwitchTo(14)<CR>:<BS>
      noremap <unique> <script> <space><space>5 <esc>:call <SID>Bf_SwitchTo(15)<CR>:<BS>
      noremap <unique> <script> <space><space>6 <esc>:call <SID>Bf_SwitchTo(16)<CR>:<BS>
      noremap <unique> <script> <space><space>7 <esc>:call <SID>Bf_SwitchTo(17)<CR>:<BS>
      noremap <unique> <script> <space><space>8 <esc>:call <SID>Bf_SwitchTo(18)<CR>:<BS>
      noremap <unique> <script> <space><space>9 <esc>:call <SID>Bf_SwitchTo(19)<CR>:<BS>
      noremap <unique> <script> <space><space>0 <esc>:call <SID>Bf_SwitchTo(20)<CR>:<BS>
      noremap <unique> <script> <space><space><space>1 <esc>:call <SID>Bf_SwitchTo(21)<CR>:<BS>
      noremap <unique> <script> <space><space><space>2 <esc>:call <SID>Bf_SwitchTo(22)<CR>:<BS>
      noremap <unique> <script> <space><space><space>3 <esc>:call <SID>Bf_SwitchTo(23)<CR>:<BS>
      noremap <unique> <script> <space><space><space>4 <esc>:call <SID>Bf_SwitchTo(24)<CR>:<BS>
      noremap <unique> <script> <space><space><space>5 <esc>:call <SID>Bf_SwitchTo(25)<CR>:<BS>
      noremap <unique> <script> <space><space><space>6 <esc>:call <SID>Bf_SwitchTo(26)<CR>:<BS>
      noremap <unique> <script> <space><space><space>7 <esc>:call <SID>Bf_SwitchTo(27)<CR>:<BS>
      noremap <unique> <script> <space><space><space>8 <esc>:call <SID>Bf_SwitchTo(28)<CR>:<BS>
      noremap <unique> <script> <space><space><space>9 <esc>:call <SID>Bf_SwitchTo(29)<CR>:<BS>
      noremap <unique> <script> <space><space><space>0 <esc>:call <SID>Bf_SwitchTo(30)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space>1 <esc>:call <SID>Bf_SwitchTo(31)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space>2 <esc>:call <SID>Bf_SwitchTo(32)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space>3 <esc>:call <SID>Bf_SwitchTo(33)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space>4 <esc>:call <SID>Bf_SwitchTo(34)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space>5 <esc>:call <SID>Bf_SwitchTo(35)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space>6 <esc>:call <SID>Bf_SwitchTo(36)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space>7 <esc>:call <SID>Bf_SwitchTo(37)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space>8 <esc>:call <SID>Bf_SwitchTo(38)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space>9 <esc>:call <SID>Bf_SwitchTo(39)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space>0 <esc>:call <SID>Bf_SwitchTo(40)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space><space>1 <esc>:call <SID>Bf_SwitchTo(41)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space><space>2 <esc>:call <SID>Bf_SwitchTo(42)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space><space>3 <esc>:call <SID>Bf_SwitchTo(43)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space><space>4 <esc>:call <SID>Bf_SwitchTo(44)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space><space>5 <esc>:call <SID>Bf_SwitchTo(45)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space><space>6 <esc>:call <SID>Bf_SwitchTo(46)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space><space>7 <esc>:call <SID>Bf_SwitchTo(47)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space><space>8 <esc>:call <SID>Bf_SwitchTo(48)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space><space>9 <esc>:call <SID>Bf_SwitchTo(49)<CR>:<BS>
      noremap <unique> <script> <space><space><space><space><space>0 <esc>:call <SID>Bf_SwitchTo(50)<CR>:<BS>
      ...
      "inoremap <unique> <script> <space>0 <esc>:call <SID>Bf_SwitchTo(10)<CR>:<BS>a
      "inoremap <unique> <script> <space><space>1 <esc>:call <SID>Bf_SwitchTo(11)<CR>:<BS>a
      "inoremap <unique> <script> <space><space>2 <esc>:call <SID>Bf_SwitchTo(12)<CR>:<BS>a
      "inoremap <unique> <script> <space><space>3 <esc>:call <SID>Bf_SwitchTo(13)<CR>:<BS>a
      "inoremap <unique> <script> <space><space>4 <esc>:call <SID>Bf_SwitchTo(14)<CR>:<BS>a
      "inoremap <unique> <script> <space><space>5 <esc>:call <SID>Bf_SwitchTo(15)<CR>:<BS>a
      "inoremap <unique> <script> <space><space>6 <esc>:call <SID>Bf_SwitchTo(16)<CR>:<BS>a
      "inoremap <unique> <script> <space><space>7 <esc>:call <SID>Bf_SwitchTo(17)<CR>:<BS>a
      "inoremap <unique> <script> <space><space>8 <esc>:call <SID>Bf_SwitchTo(18)<CR>:<BS>a
      "inoremap <unique> <script> <space><space>9 <esc>:call <SID>Bf_SwitchTo(19)<CR>:<BS>a
      "inoremap <unique> <script> <space><space>0 <esc>:call <SID>Bf_SwitchTo(20)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space>1 <esc>:call <SID>Bf_SwitchTo(21)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space>2 <esc>:call <SID>Bf_SwitchTo(22)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space>3 <esc>:call <SID>Bf_SwitchTo(23)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space>4 <esc>:call <SID>Bf_SwitchTo(24)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space>5 <esc>:call <SID>Bf_SwitchTo(25)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space>6 <esc>:call <SID>Bf_SwitchTo(26)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space>7 <esc>:call <SID>Bf_SwitchTo(27)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space>8 <esc>:call <SID>Bf_SwitchTo(28)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space>9 <esc>:call <SID>Bf_SwitchTo(29)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space>0 <esc>:call <SID>Bf_SwitchTo(30)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space>1 <esc>:call <SID>Bf_SwitchTo(31)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space>2 <esc>:call <SID>Bf_SwitchTo(32)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space>3 <esc>:call <SID>Bf_SwitchTo(33)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space>4 <esc>:call <SID>Bf_SwitchTo(34)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space>5 <esc>:call <SID>Bf_SwitchTo(35)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space>6 <esc>:call <SID>Bf_SwitchTo(36)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space>7 <esc>:call <SID>Bf_SwitchTo(37)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space>8 <esc>:call <SID>Bf_SwitchTo(38)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space>9 <esc>:call <SID>Bf_SwitchTo(39)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space>0 <esc>:call <SID>Bf_SwitchTo(40)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space><space>1 <esc>:call <SID>Bf_SwitchTo(41)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space><space>2 <esc>:call <SID>Bf_SwitchTo(42)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space><space>3 <esc>:call <SID>Bf_SwitchTo(43)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space><space>4 <esc>:call <SID>Bf_SwitchTo(44)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space><space>5 <esc>:call <SID>Bf_SwitchTo(45)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space><space>6 <esc>:call <SID>Bf_SwitchTo(46)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space><space>7 <esc>:call <SID>Bf_SwitchTo(47)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space><space>8 <esc>:call <SID>Bf_SwitchTo(48)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space><space>9 <esc>:call <SID>Bf_SwitchTo(49)<CR>:<BS>a
      "inoremap <unique> <script> <space><space><space><space><space>0 <esc>:call <SID>Bf_SwitchTo(50)<CR>:<BS>a
endif " %%
...
noremap <unique> <script> <Plug>tabbar1  :call <SID>Bf_SwitchTo( 6)<CR>:<BS>
" %%
...
function! <SID>Tb_AutoUpdt(delBufNum)
	" Asano Add Begin: LustyExplorerでTabを作らせないようにする
	if (bufname('%') == '[LustyExplorer-Files]')
		return
    endif
	" Asano Add End: LustyExplorerでTabを作らせないようにする
    if g:Tb_DBG_LVL > 0
